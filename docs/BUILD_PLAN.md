# Build plan and working notes

The sections below governed how Misquote was built. They lived in `Readme.md`
until 9 Sep 2026, at the top of the page a judge lands on — operating rules for
the agent writing the code, a phase order with gate dates, a pre-agreed cut
list, and a checklist of questions to answer before Phase 1.

They are kept because they are the record of how the decisions were made, and
several of them are cited from `docs/REQUIREMENTS_MATRIX.md` and from module
docstrings by section number. They are moved because a repository landing page
is not the place for construction scaffolding. Nothing here has been edited;
the numbering is the original.
